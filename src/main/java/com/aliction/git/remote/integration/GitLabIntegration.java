...
//		gitlab = new GitLabApi("https://gitlab.consulting.redhat.com/", "go8CsqbAqi_EzQ1sQcTR");

	}

	public GitLabIntegration(GitRemoteProperties props){

//			gitlab = new GitLabApi("https://gitlab.consulting.redhat.com/",props.getLogin(), props.getPassword());
